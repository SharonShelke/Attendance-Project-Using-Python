...
face_cas = cv2.CascadeClassifier(
    '"C:/Users/Sharon/PycharmProjects/Automatic_attendence_system_using_facial_recognition_python_openCV-main/haarcascade_frontalface_default.xml')
cap = cv2.VideoCapture(0);
recognizer = cv2.face.LBPHFaceRecognizer_create();
recognizer.read('C:/Users/Sharon/PycharmProjects/Automatic_attendence_system_using_facial_recognition_python_openCV-main/trainer.yml');
flag = 0;
id = 0;
filename = 'filename';
dict = {
